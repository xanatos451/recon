...
void loop() {
  ...
  int valHue = readChannel(5, MIN_HUE, MAX_HUE, MIN_HUE);                    // Channel 5 Pot (VrA)
  ...
  int valBright = readChannel(3, MIN_BRIGHTNESS, MAX_BRIGHTNESS, MIN_BRIGHTNESS);   // Channel 3 Left Stick (Up/Down)
